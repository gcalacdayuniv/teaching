...
* **`js/finance.js`:** Manages the Finance Tracker module. Features a dynamic 6-level deep collapsible tree (Projects -> Main Group -> Sub-Group 1 to 5), global date-range filtering, project creation, and logs transactions (Income/Expense) with integrated HTML5 Canvas Base64 image compression for receipt attachments. Merges Teaching Earnings natively into the financial overview.
