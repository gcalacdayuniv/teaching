...
* **`js/profile.js`:** Handles user profile updates (Name, Username, Email, Contact), mapped to the user's UUID, HTML5 Canvas Base64 image compression for avatars, and secure password updates.
...
* **`Resource_Links`:** Resource_ID (UUID), Category, Title, URL, Is_Deleted (Integer/Boolean for soft deletes).
