...
import { initHoursLogger } from './hours-logger.js';
import { initRecords } from './records-viewer.js';
import { initLedger } from './payment-ledger.js';
...
function initApp() {
    try {
        ...
        // 3. Initialize all modular domains functionally
        initAuth();
        initResources();
        initRecords();
        initHoursLogger();
