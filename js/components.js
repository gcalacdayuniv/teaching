    ...
    mainView.innerHTML = `
        ...
        <div id="viewPanel" class="app-view hidden max-w-6xl mx-auto flex-col space-y-4 pb-24 pt-2">
            <div class="grid grid-cols-3 gap-2 sm:gap-4 shrink-0">
                <div id="card-rendered" class="bg-white p-3 sm:p-5 rounded-xl shadow-sm border border-l-4 border-l-blue-500 flex flex-col justify-center cursor-pointer hover:shadow-md transition group">
                ...
                <div id="card-paid" class="bg-white p-3 sm:p-5 rounded-xl shadow-sm border border-l-4 border-l-green-500 flex flex-col justify-center cursor-pointer hover:shadow-md transition group">
                ...
                <div id="card-unpaid" class="bg-white p-3 sm:p-5 rounded-xl shadow-sm border border-l-4 border-l-amber-500 flex flex-col justify-center cursor-pointer hover:shadow-md transition group">
            ...
            <div class="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 bg-white p-2.5 rounded-xl shadow-sm border border-gray-200">
                <div class="flex bg-gray-100 p-1.5 rounded-lg w-full xl:w-auto overflow-x-auto">
                    <button id="tab-btn-Rendered" class="flex-1 min-w-[100px] py-1.5 px-3 text-xs font-bold rounded transition bg-white text-blue-600 shadow-sm">Rendered (All)</button>
                    <button id="tab-btn-Paid" class="flex-1 min-w-[100px] py-1.5 px-3 text-xs font-bold text-gray-500 rounded transition hover:bg-gray-200">Paid Only</button>
                </div>
                <div class="flex items-center gap-3 w-full xl:w-auto flex-wrap sm:flex-nowrap">
                    <div class="flex items-center gap-1.5 flex-1 min-w-0 bg-gray-50 border p-1 rounded-lg">
                        <input type="date" id="filterStart" class="flex-1 min-w-0 px-2 py-1 bg-transparent text-xs font-semibold outline-none cursor-pointer text-gray-600">
                        <span class="text-xs font-bold text-gray-400 shrink-0">to</span>
                        <input type="date" id="filterEnd" class="flex-1 min-w-0 px-2 py-1 bg-transparent text-xs font-semibold outline-none cursor-pointer text-gray-600">
                    </div>
        ...
        <div id="resourcePanel" class="app-view hidden max-w-3xl mx-auto space-y-4 pb-24 pt-2">
            ...
            <div id="resourceGrid" class="flex flex-col gap-2 pt-2"></div>
        </div>
